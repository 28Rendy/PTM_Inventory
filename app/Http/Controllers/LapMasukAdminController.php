...
class LapMasukAdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('content.lap-masuk-admin.barang-masuk', compact('barangMasuk', 'bulan', 'tahun'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('content.lap-masuk-admin.barang-masuk-pdf', compact('barangMasuk'));
         $today = now()->format('Y-m-d');
