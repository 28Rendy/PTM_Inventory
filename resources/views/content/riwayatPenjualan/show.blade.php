            ...
            <div class="card">
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($penjualan->user_id == auth()->id())
                                                <form id="delete-form-{{ $item->id }}" action="{{ route('Riwayatpenjualan.destroy', $item->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="mt-4 text-start">
                        <a href="{{ route('Riwayatpenjualan.index') }}" class="btn btn-secondary btn-sm">← Kembali</a>
                    </div>
                </div>
            </div>
        </div>
