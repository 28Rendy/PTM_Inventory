    ...
    <div class="container py-5" style="margin-top: 100px;">
        <div class="card shadow-sm rounded-4 border-0">
            <div class="card-body">
                ...
                <form action="{{ route('laporan.barang-masuk') }}" method="GET" class="row g-3 align-items-end mb-4">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="{{ route('laporan.barang-masuk.excel', request()->only(['bulan', 'tahun'])) }}"
                            class="btn btn-success me-2">Export Excel</a>
                        <a href="{{ route('laporan.barang-masuk.pdf', request()->only(['bulan', 'tahun'])) }}"
